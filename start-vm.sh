...
sudo qemu-system-x86_64 -machine accel=kvm -smp 2 -m 4096 \
  ...
  -display gtk \
  -virtfs local,path=/var/cache/pacman/pkg,mount_tag=host0,security_model=passthrough,id=host0
#-virtfs local,path=/var/cache/pacman/pkg,mount_tag=host0,security_model=none,id=host0
